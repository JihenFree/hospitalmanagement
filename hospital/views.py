...
def admin_view_doctor_view(request):
    ...
    return render(request,'hospital/admin_view_doctor.html',{'admin':admin,'doctors':doctors})
...
def admin_patient_view(request):
    admin=request.user
    return render(request,'hospital/admin_patient.html',{'admin':admin})
...
def admin_view_patient_view(request):
    ...
    return render(request,'hospital/admin_view_patient.html',{'patients':patients,'admin':admin})
...
def update_patient_view(request,pk):
    ...
    mydict={'admin':admin,'userForm':userForm,'patientForm':patientForm}
    if request.method=='POST':
...
def admin_discharge_patient_view(request):
    admin=request.user
    patients=models.Patient.objects.all().filter(status=True)
    return render(request,'hospital/admin_discharge_patient.html',{'patients':patients,'admin':admin})
